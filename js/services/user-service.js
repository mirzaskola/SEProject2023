const UserService = {
    ...
    redirectToLogin: function () {
        ...
        if (token == null || token == undefined) window.location.replace("login.html");
    ...
    checkUserRole: function(current_url){
      $.ajax({
        url: 'api/user/checkuser',
        type: 'GET',
        beforeSend: function(xhr){
    ...
    updateMyProfile: function(entity){
      $(".save-changes-button").attr('disabled', true);

      $.ajax({
        url: 'api/user/myprofile/'+$('#editProfileForm input[name="id"]').val(),
        type: 'PUT',
        beforeSend: function(xhr){
          xhr.setRequestHeader('Authorization', localStorage.getItem('token'));
        },
    ...
    updatePasswordMyProfile: function(entity){
      $(".save-changes-button").attr('disabled', true);

      $.ajax({
        url: 'api/user/changepassword/'+$('#changePasswordForm input[name="id"]').val(),
        type: 'PUT',
        beforeSend: function(xhr){
          xhr.setRequestHeader('Authorization', localStorage.getItem('token'));
        },
